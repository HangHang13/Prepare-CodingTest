...
INNER JOIN CAR_RENTAL_COMPANY_RENTAL_HISTORY C ON R.CAR_ID = C.CAR_ID  //AND R.CAR_TYPE = '세단'
WHERE TO_CHAR(C.START_DATE,'YYYY-MM') = '2022-10' AND R.CAR_TYPE = '세단'
ORDER BY R.CAR_ID DESC
```



속도측면 조건 필터링은 where절에서 하는게 낫다.